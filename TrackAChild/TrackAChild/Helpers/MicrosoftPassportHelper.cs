...
namespace TrackAChild.Helpers
{
    public static class MicrosoftPassportHelper
    {
        ...
        /// <summary>
        /// Creates a Passport key on the machine using the UserModel id passed.
        /// </summary>
        /// <param name="accountId">The UserModel id associated with the UserModel that we are enrolling into Passport</param>
